...
<body>
                            ...
                            <div class="block block-layered-nav">
                                ...
                                <div class="block-content">
                                    <dl id="narrow-by-list">
                                        ...
                                        <dd class="tabcontent2">
                                            <div class="price">
                                                ...
                                                <div class="text-box">
                                                    ...
                                                    <div class="price-to">
                                                        <input type="text" name="max" id="maxPrice" class="priceTextBox" value="1000" />
                                                    </div>
                                        ...
                                        <dt id="tab3" class="tab-accordion accordion-open">All</dt>
                                ...
                                <div id="box-banner" class="carousel slide" data-ride="carousel" data-interval="1500">
                                    ...
                                    <div class="carousel-inner">
                                        <div class="item active">
                                            <a href="detail.html"><img src="images/banner13.png" alt="banner" /></a>
                                            <div class="std">
                                        ...
                                        <div class="item">
                                            <a href="detail.html"><img src="images/banner14.png" alt="banner" /></a>
                                            <div class="std">
                                        ...
                                        <div class="item">
                                            <a href="detail.html"><img src="images/banner15.png" alt="banner" /></a>
                                            <div class="std">
                    ...
                    <div class="row">
                        <div class="row">
                            <div class="box-connect col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                ...
                                <a href="detail.html" class="face-book">face book</a>
                                <a href="detail.html" class="tweeter">tweeter</a>
                                <a href="detail.html" class="no-name">no-name</a>
                                <a href="detail.html" class="pinseter">pinseter</a>
                                <a href="detail.html" class="google">google+</a>
                                <a href="detail.html" class="init">init</a>
                            </div>
    ...
    <!-- Mirrored from demo.7uptheme.com/html/mello/grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 25 Jul 2015 06:57:24 GMT -->
